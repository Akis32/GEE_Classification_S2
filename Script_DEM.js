...
function main (){
 ...
 var Img = S2.filterDate(date_start,date_end)
  ...
  var trainSet = trainData.filter(ee.Filter.lessThan('random', 0.85));
  var testSet = trainData.filter(ee.Filter.greaterThanOrEquals('random', 0.85));
  ...
  Map.addLayer(classifiedImg_smooth, {palette: classPalette, min: 0, max: 8}, 'Land Cover Smooth',false);
  ...
  print('Kappa statistic', errorMatrix.kappa());
